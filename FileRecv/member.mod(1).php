...
//					));
	...
	function Showbill()
	{
    	...
    	if ($value['name']=='zn' || $value['name']=='zz')
        	...
        	}elseif (($value['name']=='卖出ETH') or ($value['name']=='卖出BTC'))
		...
		$ticket = $query->GetRow();
        	...
        	{
        		$info['name']="卖出商品";
        	}elseif ($info['name']=='卖出BTC')
        	{
        		$info['name']="卖出BTC";
        	}elseif ($info['name']=='卖出ETH')
			{
				$info['name']="卖出ETH";
	...
	while($row = $query->GetRow())
		{
        	...
        	{
        		$row['name']="卖出商品";
        	}elseif ($row['name']=='卖出BTC')
			{
				$row['name']="卖出BTC";
			}elseif ($row['name']=='卖出ETH')
			{
				$row['name']="卖出ETH";
			}
        ...
        if(!empty($log) && is_array($log)) {
        	...
        	}elseif ($name =='cp')
        	{
        		...
        		$log[$k]['intro'] = "
						...
						<b>商品名称：</b>".$orderinfo['product']['name'];
			$log[$k]['name']="卖出商品";
        	}elseif (($name =='卖出BTC') or ($name =='卖出ETH'))
        	{
