...
public class CurveFitter {
	public static void main(String[] args) {
		double xData[] = { 0.00, 0.025, 0.05, 0.1, 0.25, 0.75 };
		double yData[] = { 1.4735, 1.214, 1.0143, 0.7362, 0.3907, 0.2135 };
		CurveFitter curveFitter = new CurveFitter(xData, yData);
		curveFitter.doFit(7);
		curveFitter.getFit();
		double res[] = curveFitter.getParams();
		for (int i = 0; i < res.length; i++) {
			System.out.println(res[i]);
		}
		System.out.println("------");
		System.out.println(curveFitter.getFitGoodness());
		System.out.println(curveFitter.getResultString());
	}
