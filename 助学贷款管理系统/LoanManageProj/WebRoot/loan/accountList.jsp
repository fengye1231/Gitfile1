				...
				<table width="80%" border="0" align="center" cellpadding="0"
					...
					<s:iterator value="accountList">
						<tr>
							...
							<td align="center">
								<a
									href="account_updateInput?updateAccount.accountId=<s:property value="accountId"/>">修改</a>
								<a
									href="account_delAccount?delAccount.accountId=<s:property value="accountId"/>">删除</a>
							</td>
						</tr>
					</s:iterator>
					<tr>
